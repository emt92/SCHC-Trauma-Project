...
Var1 <- Pediatric_Data_Under_18 %>% 
  mutate(ethnicity = factor(ETHNICITY, labels = c("Not Recorded", "Hispanic or Latino", "Non-Hispanic/Latino")),
         ...
         Prophylaxis_Type = factor(VTEPROPHYLAXISTYPE, levels = c(1,5,6,7,8,9,10), labels = c("Heparin", "None","LMWH","Direct Thrombin Inhibitor", "Xa Inhibitor","Coumadin","other")),
         Hemorrhage_Surgery_Type = factor(HMRRHGCTRLSURGTYPE, levels = c(1,2,3,4,5,6,7,8), labels = c("None","Laparotomy","Thoracotomy","Sternotomy","Extremity","Neck","Traumatic Amputation","Other Skin/Soft Tissue"))) %>%
